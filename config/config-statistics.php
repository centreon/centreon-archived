...
const AUTH_URL = 'http://localhost/centreon/api/index.php?action=authenticate';

// Route of the webservices
const WS_ROUTE = 'http://localhost/centreon/api/index.php?object=centreon_statistics&action=';
