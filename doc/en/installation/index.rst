...
The monitoring platform may be installed in several ways. However, **we strongly recommend using Centreon ISO (ex CES) to install your platform**. Enjoy of our work of industrialization durinf install and update steps of your the environment. Also enjoy optimizations installed by default on the system.
