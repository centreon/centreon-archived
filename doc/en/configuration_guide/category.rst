...
Centreon 2.4 includes a new functionality called “Severity”. As from version 2.5, the levels of critically are linked to a category, they have become a type of category. A critically level is an indicator for defining the critically of a host or a service. The aim is to be able to handle the problems of hosts or services by order of priority. By this system, it is thus possible to filter the objects in the “Supervision” views by critically.
...
* The **Severity type** box signifies that the category of hosts has a critically level.
* The **Level** and **Icon** fields define a critically level and an associated icon respectively.
...
* The **Severity type** box signifies that the category of service has a critically level.
* The **Level** and **Icon** fields define a critically level and an associated icon respectively.
