...
Il est très important lorsque vous souhaitez mettre à jour votre système vous reporter à cette section afin de connaîtres les changements de comportement ou les changements majeurs qui ont été opérés sur cette version. Cela vous permettra de connaître l'impact de l'installation de ces version sur les fonctionnalités que vous utilisez ou sur les développements spécifiques que vous avez intégrés sur votre plateforme (modules, widgets, plugins).
