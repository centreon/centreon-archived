...
* Si la case **Inverser** est cochée, la courbe est inversée sur l'axe des ordonnées (utile pour voir la proportion du traffic entrant par rapport au traffic sortant)
...
Les attributs ci-dessous concernent les informations situées en desous du graphique.
