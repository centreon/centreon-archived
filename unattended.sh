...
function set_required_prerequisite() {
	...
	7*)
		...
		centos-release* | centos-linux-release* | rocky-release* | almalinux-release*)
	...
	8*)
		...
		centos-release-8.[3-9]* | centos-linux-release* | centos-stream-release* | rocky-release* | almalinux-release*)
			BASE_PACKAGES=(dnf-plugins-core epel-release)
