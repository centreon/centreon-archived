...
class ServiceProvider implements AutoloadServiceProviderInterface
{
    ...
    public function register(Container $pimple): void
    {
        ...
        $pimple[self::CENTREON_REMOTE_EXPORTER] = function (Container $container): Infrastructure\Service\ExporterService {
        ...
        // Commands
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\CommandExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Pollers
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\PollerExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
                'centreon.config',
            ];
        ...
        // Hosts
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\HostExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Meta services
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\MetaServiceExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Services
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\ServiceExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Traps
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\TrapExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Time periods
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\TimePeriodExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Downtimes
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\DowntimeExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Graphs
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\GraphExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
        ...
        // Media
        $pimple[self::CENTREON_REMOTE_EXPORTER]->add(Domain\Exporter\MediaExporter::class, function() use ($pimple) {
            $services = [
                \Centreon\ServiceProvider::CENTREON_DB_MANAGER,
            ];
