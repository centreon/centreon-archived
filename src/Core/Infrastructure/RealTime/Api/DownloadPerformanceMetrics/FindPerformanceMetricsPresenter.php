...
use Core\Application\RealTime\UseCase\FindPerformanceMetrics\FindPerformanceMetricsResponse;
...
class FindPerformanceMetricsPresenter extends AbstractPresenter implements FindPerformanceMetricsPresenterInterface
{
    /**
     * {@inheritDoc}
     * @param FindPerformanceMetricsResponse $data
     */
    public function present(mixed $presenterResponse): void
    {
