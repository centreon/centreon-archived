 ...
 */
private
function getContactTemplateOrFail(?array $contactTemplateFromRequest): ?ContactTemplate
{
 ...
 */
private
function getContactGroupOrFail(int $contactGroupId): ContactGroup
{
 ...
 */
private
function createAuthorizationRules(array $authorizationRulesFromRequest): array
{
 ...
 */
private
function logNonExistentAccessGroupsIds(array $accessGroupIdsFromRequest, array $foundAccessGroups): void
{
    $foundAccessGroupsId = [];
 ...
 */
private
function findAccessGroupFromFoundAccessGroups(
 ...
 */
private
function getAccessGroupIds(array $authorizationRulesFromRequest): array
{
    $accessGroupIds = [];
