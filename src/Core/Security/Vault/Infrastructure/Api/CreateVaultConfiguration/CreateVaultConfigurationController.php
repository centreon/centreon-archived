...
final class CreateVaultConfigurationController extends AbstractController
{
    ...
    public function __invoke(
        ...
        $user = $this->getUser();
        if (! $user->isAdmin()) {
            $presenter->setResponseStatus(new UnauthorizedResponse('Only admin user can create vault configuration'));
        ...
        $createVaultConfigurationRequest = $this->createCreateVaultConfigurationRequest($decodedRequest);
