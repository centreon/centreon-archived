...
class SecurityPolicy
{
    ...
    public function __construct(
        ...
        if ($passwordExpiration !== null) {
            Assertion::min($passwordExpiration, self::MIN_PASSWORD_EXPIRATION, 'SecurityPolicy::passwordExpiration');
            Assertion::max($passwordExpiration, self::MAX_PASSWORD_EXPIRATION, 'SecurityPolicy::passwordExpiration');
        }
