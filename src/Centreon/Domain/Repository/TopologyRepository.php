...
class TopologyRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = file_get_contents(__DIR__ . '/../../src/Centreon/Infrastructure/Resources/sql/disablemenus.sql');
    ...
    {
        $sql = file_get_contents(__DIR__ . '/../../src/Centreon/Infrastructure/Resources/sql/enablemenus.sql');
        $stmt = $this->db->prepare($sql);
        return $stmt->execute();
    }
