...
final class HostGroupService extends AbstractCentreonService implements HostGroupServiceInterface
{
     ...
     */
    public function __construct(private readonly HostGroupRepositoryInterface $hostGroupRepository, private readonly ReadAccessGroupRepositoryInterface $accessGroupRepository)
    {
    }
