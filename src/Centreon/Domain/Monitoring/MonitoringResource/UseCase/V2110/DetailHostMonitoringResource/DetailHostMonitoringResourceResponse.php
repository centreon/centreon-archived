...
/**
 * This class is a DTO for the detailHostMonitoringResource use case.
 *
 * @package Centreon\Domain\Monitoring\MonitoringResource\UseCase\v2110\DetailHostMonitoringResource
 */
class DetailHostMonitoringResourceResponse
{
    /**
     ...
     */
    public function setHostMonitoringResourceDetail(MonitoringResource $monitoringResource): void
    {
        $this->monitoringResource = $this->monitoringResourceToArray($monitoringResource);
    }

    /**
     * @return array<string, mixed> $monitoringResource
     */
    public function getHostMonitoringResourceDetail(): array
    {
