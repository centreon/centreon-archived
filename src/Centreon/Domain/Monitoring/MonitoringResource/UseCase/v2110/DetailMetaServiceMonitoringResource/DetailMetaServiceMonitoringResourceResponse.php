 ...
 */
class DetailMetaServiceMonitoringResourceResponse
{
    /**
     ...
     */
    public function setMetaServiceMonitoringResourceDetail(MonitoringResource $monitoringResource): void
    {
     ...
     */
    public function getMetaServiceMonitoringResourceDetail(): array
    {
