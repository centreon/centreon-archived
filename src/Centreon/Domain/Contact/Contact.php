...
class Contact implements UserInterface, ContactInterface
{
    ...
    public const ROLE_CONFIGURATION_META_SERVICES_WRITE = 'ROLE_CONFIGURATION_META_SERVICES_BY_HOST_RW';
    public const ROLE_CONFIGURATION_META_SERVICES_READ = 'ROLE_CONFIGURATION_META_SERVICES_BY_HOST_R';
