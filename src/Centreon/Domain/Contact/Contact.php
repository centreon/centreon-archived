...
class Contact implements UserInterface, ContactInterface
{
    ...
    public const ROLE_CONFIGURATION_USERS_CONTACTS__USERS_READ_WRITE = 'ROLE_CONFIGURATION_USERS_CONTACTS__USERS_RW';
    public const ROLE_CONFIGURATION_USERS_CONTACTS__USERS_READ = 'ROLE_CONFIGURATION_USERS_CONTACTS__USERS_R';
