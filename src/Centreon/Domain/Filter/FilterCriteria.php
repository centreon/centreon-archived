...
class FilterCriteria
{
    ...
    /**
     * @var string|null Type of the filter
     */
    private $type;

    /**
     * @var string|array|boolean|null Value of the filter
     */
    private $value;

    /**
     * @var string|null Type of the objects filled in the filter
     */
    private $objectType;
    ...
    /**
     * @param string|array|boolean|null $value
     * @return FilterCriteria
     */
