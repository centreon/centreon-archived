...
/**
 * This class is a DTO for all use cases concerning the generation and reloading of monitoring server configurations.
 *
 * @package Centreon\Domain\MonitoringServer\UseCase
 */
class GenerateReloadConfigurationResponse
{
    /**
     * @var bool
     */
