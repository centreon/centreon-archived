...
final class ContactRepositoryRDB implements ContactRepositoryInterface
{
    ...
    private function createContact(array $contact): Contact
    {
        ...
        $contactPlatformDataSending = isset($contact['contact_platform_data_sending'])
            ? (int) $contact['contact_platform_data_sending']
            : null;
        ...
        return (new Contact())
            ...
            ->setDefaultPage($page)
            ->setPlatformDataSending($contactPlatformDataSending);
    }
