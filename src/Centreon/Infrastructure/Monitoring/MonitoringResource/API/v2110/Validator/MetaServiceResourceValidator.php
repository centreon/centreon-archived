...
class MetaServiceResourceValidator implements Validator\Interfaces\MonitoringResourceValidatorInterface
{
    /**
     * @var string $type Type of Monitoring Resource
     */
    private const TYPE = 'metaservice';
    ...
    public function validateOrFail(array $monitoringResource): void
    {
        ...
        Assertion::eq($monitoringResource['type'], 'metaservice', 'resource::type');
