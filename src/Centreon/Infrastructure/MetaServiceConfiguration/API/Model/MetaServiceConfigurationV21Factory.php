...
class MetaServiceConfigurationV21Factory
{
     ...
     */
    public static function createOneMetaServiceConfigurationFromResponse(FindOneMetaServiceConfigurationResponse $response): MetaServiceConfigurationV21
    {
     ...
     * @return MetaServiceConfigurationV21[]
     */
    public static function createMultipleMetaServicesConfigurationsFromResponse(FindMetaServicesConfigurationsResponse $response): array
    {
