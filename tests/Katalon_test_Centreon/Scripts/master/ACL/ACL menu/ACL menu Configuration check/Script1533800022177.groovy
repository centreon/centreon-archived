...
if(file.getValue('Configuration', 1) == '1') {
	...
	if(file.getValue('Conf/Hosts', 1) == '1'){
		...
		element = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Categories', true)
	...
	span = WebUI.modifyObjectProperty(span, 'text', 'equals', 'Services', true)
	
	//This checks the Configuration/Services page
	if(file.getValue('Conf/Services', 1) == '1'){		
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Services by host', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Services by host group', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Categories', true)
	...
	span = WebUI.modifyObjectProperty(span, 'text', 'equals', 'Users', true)
	
	//This checks the Configuration/Users page
	if(file.getValue('Conf/Users', 1) == '1'){		
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Contacts / Users', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Contact Templates', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Contact Groups', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Time Periods', true)
	...
	span = WebUI.modifyObjectProperty(span, 'text', 'equals', 'Commands', true)
	
	//This checks the Configuration/Commands page
	if(file.getValue('Conf/Commands', 1) == '1'){
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Checks', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Notifications', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Discovery', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Miscellaneous', true)
		...
		p = WebUI.modifyObjectProperty(p, 'text', 'equals', 'Connectors', true)
