...
if(home.getValue('Home', 1) == '1' && home.getValue('Cust/Widget Parameters', 1) == '1'){
	WebUI.callTestCase(findTestCase('master/Create view'), 
		...
		'userPassword' : user.getValue('password', 1), 'addView' : home.getValue('Cust/Add View', 1)])
					...
					//Restore these lines when you can create a widget
	/*WebUI.callTestCase(findTestCase('master/Create widget view'),
		['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
		'userPassword' : user.getValue('password', 1), 'addWidget' : home.getValue('Cust/Add Widget', 1)])*/
}

//I launch the acl menu check on Home page
WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Home check'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
...
WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Monitoring check'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
	'userPassword' : user.getValue('password', 1)])
...
WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Reporting check'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
	'userPassword' : user.getValue('password', 1)])
...
WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Configuration check'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
	'userPassword' : user.getValue('password', 1)])

WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Configuration check part2'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
	'userPassword' : user.getValue('password', 1)])
...
WebUI.callTestCase(findTestCase('master/ACL/ACL menu/ACL menu Administration check'),
	['userName' : config.getValue('TimeIndicator', 1) + user.getValue('UserName', 1) + '1',
	'userPassword' : user.getValue('password', 1)])
