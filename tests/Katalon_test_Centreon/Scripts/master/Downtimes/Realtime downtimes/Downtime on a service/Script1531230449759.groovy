...
WebUI.waitForElementClickable(findTestObject('General/input_Checkall'), 3)
...
def element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Downtimes/input_Services'),
	'placeholder', 'equals', 'Services', true)
...
WebUI.setText(element,
	config.getValue('TimeIndicator', 1) + hostfile.getValue('hostName', 1) + '1 - ' + sgfile.getValue('Service', 1))
