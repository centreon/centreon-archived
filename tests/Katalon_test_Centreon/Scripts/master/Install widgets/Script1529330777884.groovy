...
WebUI.mouseOver(findTestObject('Administration/Extensions/span_Extensions'))

WebUI.click(findTestObject('Administration/Extensions/Widget installation/p_Widgets'))
