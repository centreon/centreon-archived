...
WebUI.click(findTestObject('Configuration/Host/span_Host'))
...
WebUI.setText(search, config.getValue('TimeIndicator', 1) + file.getValue('hostName', 2) + '1')
...
def host = WebUI.modifyObjectProperty(findTestObject('Configuration/Host/Duplicate host/a_pouic'),
	'text', 'equals', config.getValue('TimeIndicator', 1) + file.getValue('hostName', 2) + '1', true)
