...
WebUI.click(findTestObject('Configuration/Users/User creation/span_Users'))
...
WebUI.callTestCase(findTestCase('master/Login/Autologin'),
...
WebUI.callTestCase(findTestCase('master/Login/Login'), ['userName' : config.getValue('TimeIndicator', 1)
