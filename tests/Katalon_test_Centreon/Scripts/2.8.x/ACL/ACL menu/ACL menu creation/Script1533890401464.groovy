...
WebUI.callTestCase(findTestCase('2.8.x/ACL/ACL menu/ACL menu Home configuration'), ['ACLMenuName' : ACLMenuName])

//**************************************************************Monitoring**************************************************************//

WebUI.callTestCase(findTestCase('2.8.x/ACL/ACL menu/ACL menu Monitoring configuration'), ['ACLMenuName' : ACLMenuName])

//**************************************************************Reporting***************************************************************//

WebUI.callTestCase(findTestCase('2.8.x/ACL/ACL menu/ACL menu Reporting configuration'), ['ACLMenuName' : ACLMenuName])

//************************************************************Configuration*************************************************************//

WebUI.callTestCase(findTestCase('2.8.x/ACL/ACL menu/ACL menu Configuration configuration'), ['ACLMenuName' : ACLMenuName])
	
//************************************************************Administration************************************************************//

WebUI.callTestCase(findTestCase('2.8.x/ACL/ACL menu/ACL menu Administration configuration'), ['ACLMenuName' : ACLMenuName])
