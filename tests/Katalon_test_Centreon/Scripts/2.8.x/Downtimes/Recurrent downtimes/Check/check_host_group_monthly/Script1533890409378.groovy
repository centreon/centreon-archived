...
//*************************************************Go to Status Details hosts page*************************************************//
...
WebUI.setText(search, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_15')

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Monitoring/Status details/Hosts/img_Downtime icon'), 3)

WebUI.setText(search, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_16')
