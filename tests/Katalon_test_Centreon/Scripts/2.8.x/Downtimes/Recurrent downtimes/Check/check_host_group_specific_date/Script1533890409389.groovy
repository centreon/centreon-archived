...
WebUI.setText(search, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_9')

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Monitoring/Status details/Hosts/img_Downtime icon'), 3)

WebUI.setText(search, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_10')
