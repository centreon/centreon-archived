...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'), 
    config.getValue('TimeIndicator', 1) + 'Katalon_service_group_weekly')
...
WebUI.setText(element, config.getValue('TimeIndicator', 1) + 'weekly_sg')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'),
	'title', 'equals', config.getValue('TimeIndicator', 1) + 'weekly_sg', true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT',
	config.getValue('TimeIndicator', 1) + 'Katalon_service_group_weekly', false)
