...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'), 
    config.getValue('TimeIndicator', 1) + 'Katalon_service_weekly')
...
WebUI.setText(element, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_2')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'), 'title', 'equals',
	config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_2 - ' + sgFile.getValue('Service', 1), true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT',
	config.getValue('TimeIndicator', 1) + 'Katalon_service_weekly', false)
