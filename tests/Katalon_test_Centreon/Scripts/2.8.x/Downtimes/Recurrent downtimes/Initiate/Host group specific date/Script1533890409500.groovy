...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'), 
    config.getValue('TimeIndicator', 1) + 'Katalon_host_group_specific_date')
...
element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/input_Hosts'),
	'placeholder', 'equals', 'Linked with Host Groups', true)

WebUI.setText(element, config.getValue('TimeIndicator', 1) + 'specific_date_hg')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'),
	'title', 'equals', config.getValue('TimeIndicator', 1) + 'specific_date_hg', true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT', 
	config.getValue('TimeIndicator', 1) + 'Katalon_host_group_specific_date', false)
