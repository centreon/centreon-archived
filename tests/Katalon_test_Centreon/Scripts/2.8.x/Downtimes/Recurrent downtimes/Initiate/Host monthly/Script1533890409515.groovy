...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'),
	config.getValue('TimeIndicator', 1) + 'Katalon_host_monthly')
...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_Hosts'),
	config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_7')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'),
	'title', 'equals', config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_7', true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT',
	config.getValue('TimeIndicator', 1) + 'Katalon_host_monthly', false)
