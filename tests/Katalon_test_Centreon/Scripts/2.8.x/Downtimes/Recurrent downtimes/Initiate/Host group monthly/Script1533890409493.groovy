...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'), 
    config.getValue('TimeIndicator', 1) + 'Katalon_host_group_monthly')
...
WebUI.setText(element, config.getValue('TimeIndicator', 1) + 'monthly_hg')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'),
	'title', 'equals', config.getValue('TimeIndicator', 1) + 'monthly_hg', true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT',
	config.getValue('TimeIndicator', 1) + 'Katalon_host_group_monthly', false)
