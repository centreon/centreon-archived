...
WebUI.setText(findTestObject('Monitoring/Recurrent downtimes/input_downtime_name'), 
    config.getValue('TimeIndicator', 1) + 'Katalon_service_specific_date')
...
element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/input_Hosts'),
	'placeholder', 'equals', 'Linked with Services', true)

WebUI.setText(element, config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_14')

element = WebUI.modifyObjectProperty(findTestObject('Monitoring/Recurrent downtimes/div'), 'title', 'equals',
	config.getValue('TimeIndicator', 1) + hostFile.getValue('hostName', 2) + '1_14 - ' + sgFile.getValue('Service', 1), true)
...
CustomKeywords.'custom.creationVerified.verifyObjectCreated'('searchDT',
	config.getValue('TimeIndicator', 1) + 'Katalon_service_specific_date', false)
