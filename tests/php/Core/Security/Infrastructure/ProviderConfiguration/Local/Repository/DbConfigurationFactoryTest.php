...
namespace Tests\Core\Security\Infrastructure\ProviderConfiguration\Local\Repository;

use PHPUnit\Framework\TestCase;
use Centreon\Domain\Common\Assertion\AssertionException;
use Core\Security\Domain\ProviderConfiguration\Local\Model\SecurityPolicy;
use Core\Security\Infrastructure\ProviderConfiguration\Local\Repository\DbConfigurationFactory;
