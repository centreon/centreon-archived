...
namespace Tests\Core\Security\Infrastructure\Api\LogoutSession;
...
use Core\Security\Infrastructure\Api\LogoutSession\LogoutSessionController;
use Core\Security\Infrastructure\Api\LogoutSession\LogoutSessionPresenter;
