...
namespace Tests\Core\Application\Security\UseCase\FindProviderConfigurations;

use Core\Application\Security\UseCase\FindProviderConfigurations\FindProviderConfigurations;
