...
ALTER TABLE `cfg_meta_services` DROP FOREIGN KEY `meta_service_ibfk_1`;
ALTER TABLE `cfg_meta_services` DROP FOREIGN KEY `meta_service_ibfk_2`;
...
ALTER TABLE `cfg_hosts_services_relations` DROP FOREIGN KEY `cfg_host_service_relation_ibfk_1`;
