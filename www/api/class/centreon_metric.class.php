...
class CentreonMetric extends CentreonWebService
{
     ...
     * @param int    $exception  Throw exception or return integer
     *
     * @return int
     */
    private function checkAcl($hostId, $serviceId, $aclGroups, $isAdmin=1, $exception=null)
    {
        if (!$isAdmin) {
