 ...
 */
if (($o == MACRO_MODIFY || $o == MACRO_WATCH) && $resource_id) {
    $DBRESULT = $pearDB->query(
        "SELECT * FROM cfg_resource WHERE resource_id = '" . $resource_id . "' LIMIT 1"
    );
    // Set base value
...
if ($form->validate()) {
    ...
    if ($form->getSubmitValue("submitA")) {
        ...
        updateResourceInDB((int) $rsObj->getValue());
    }
    $o = null;
    $form->addElement(
        "button",
