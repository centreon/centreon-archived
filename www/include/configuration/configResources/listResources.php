...
*/
	...
	$elemArr = array();	for ($i = 0; $res->fetchInto($resource); $i++) {
		...
		$moptions .= "<select style='margin-bottom: 3px;' name='dupNbr[".$resource['resource_id']."]'><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>10</option></select>";
