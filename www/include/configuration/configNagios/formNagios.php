...
$form->addElement('text', 'translate_passive_host_checks', _("Translate Passive Host Checks Option"), $attrsText3);
$form->addElement('text', 'passive_host_checks_are_soft', _("Passive Host Checks Are SOFT Option"), $attrsText3);
