...
function getNagiosCfgColumnsDetails(): array
{
    return [
        ...
        'check_for_orphaned_hosts' => ['isRadio' => true, 'default' => '1'],
        'check_for_orphaned_services' => ['isRadio' => true, 'default' => '1'],
        'check_host_freshness' => ['isRadio' => true, 'default' => '0'],
        'check_service_freshness' => ['isRadio' => true, 'default' => '0'],
        ...
        'enable_predictive_host_dependency_checks' => ['isRadio' => true, 'default' => '1'],
        'enable_predictive_service_dependency_checks' => ['isRadio' => true, 'default' => '1'],
