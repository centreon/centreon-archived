 ...
 */
	...
	function insertNagios($ret = array(), $brokerTab = array())
	{
		...
		$rq = "INSERT INTO cfg_nagios (" .
				...
				"`max_host_check_spread` , `check_result_reaper_frequency` , `max_check_result_reaper_time`, `auto_reschedule_checks` , `auto_rescheduling_interval` , " .
        ...
        isset($ret["host_perfdata_file_template"]) && $ret["host_perfdata_file_template"] != NULL ? $rq .= "'".  mysql_real_escape_string($ret["host_perfdata_file_template"])."',  " : $rq .= "NULL, ";
        isset($ret["service_perfdata_file_template"]) && $ret["service_perfdata_file_template"] != NULL ? $rq .= "'".mysql_real_escape_string($ret["service_perfdata_file_template"])."',  " : $rq .= "NULL, ";
	...
	function updateNagios($nagios_id = null) {
        ...
        isset($ret["host_perfdata_file_template"]) && $ret["host_perfdata_file_template"] != NULL ? $rq .= "host_perfdata_file_template = '".  mysql_real_escape_string($ret["host_perfdata_file_template"])."',  " : $rq .= "host_perfdata_file_template = NULL, ";
        isset($ret["service_perfdata_file_template"]) && $ret["service_perfdata_file_template"] != NULL ? $rq .= "service_perfdata_file_template = '".mysql_real_escape_string($ret["service_perfdata_file_template"])."',  " : $rq .= "service_perfdata_file_template = NULL, ";
