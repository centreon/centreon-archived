...
*/
	...
	if (PEAR::isError($pearDB))
		print "DB Error : SELECT maxViewConfiguration FROM general_opt LIMIT 1 : ".$pearDB->getMessage()."<br>";
	...
	if (PEAR::isError($DBRESULT))
		print "DB Error : SELECT COUNT(*) FROM cfg_cgi... : ".$DBRESULT->getMessage()."<br>";
	...
	if (PEAR::isError($DBRESULT))
		print "DB Error : ELECT cgi_id, cgi_name, cgi_comment, cgi_activate... : ".$DBRESULT->getMessage()."<br>";
