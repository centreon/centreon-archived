 ...
 */
	...
	function updateServer($id = null)	{
        ...
        isset($ret["monitoring_engine"]) && $ret["monitoring_engine"] != NULL ? $rq .= "nagios_bin = '".htmlentities(trim($ret["monitoring_engine"]), ENT_QUOTES, "UTF-8")."',  " : $rq .= "monitoring_engine = NULL, ";
