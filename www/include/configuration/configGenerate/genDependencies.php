 ...
 */
	...
	while($dependency = $DBRESULT->fetchRow())	{
		$BP = false;
				...
				"FROM dependency_servicegroupParent_relation dsgpr, servicegroup, servicegroup_relation sgr ".
		...
		$query = "SELECT DISTINCT servicegroup.sg_id, servicegroup.sg_name ".
				"FROM dependency_servicegroupChild_relation dsgcr, servicegroup, servicegroup_relation sgr ".
