...
foreach ($pollers as $id) {
    $idBindString .= "?,";
}

// Add task to export files of there is a remote
$idBindString = rtrim($idBindString, ',');
$queryPollers = "SELECT ns.id as remote_id, ns.ns_ip_address as ip FROM nagios_server as ns
