...
$help["hc_severity_level"] = dgettext("help", "Severity level, must be a number. The items displayed will be sorted in ascending order. Thus the lowest severity is considered than the highest priority.");
