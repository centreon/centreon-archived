 ...
 */
	...
	for ($i = 0; $DBRESULT->fetchInto($cg); $i++) {		
		...
		$moptions .= "<a href='main.php?p=".$p."&cg_id=".$cg['cg_id']."&o=d&select[".$cg['cg_id']."]=1&num=".$num."&limit=".$limit."&search=".$search."' onclick=\"return confirm('"._("Do you confirm the deletion ?")."')\"><img src='img/icones/16x16/delete.gif' border='0' alt='"._("Delete")."'></a>&nbsp;&nbsp;-->";
		if ($cg["cg_activate"])
