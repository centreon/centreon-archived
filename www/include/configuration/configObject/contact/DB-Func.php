 ...
 */
	...
	function insertContact($ret = array())	{
		...
		isset($ret["contact_name"]) && $ret["contact_name"] != NULL ? $rq .= "'".$pearDB->escape($ret["contact_name"])."', ": $rq .= "NULL, ";
		isset($ret["contact_alias"]) && $ret["contact_alias"] != NULL ? $rq .= "'".$pearDB->escape($ret["contact_alias"])."', ": $rq .= "NULL, ";
