...
*/
	...
	$form->addElement('select', 'o1', NULL, array(NULL=>$lang["lgd_more_actions"], "m"=>$lang['dup'], "d"=>$lang['delete'], "ms"=>$lang['enable'], "mu"=>$lang['disable']), $attrs1);
	...
	$attrs2 = array(
		'onchange'=>"javascript: " .
				...
				" 	setO(this.form.elements['o2'].value); submit();} " .
				"this.form.elements['o1'].selectedIndex = 0");
    $form->addElement('select', 'o2', NULL, array(NULL=>$lang["lgd_more_actions"], "m"=>$lang['dup'], "d"=>$lang['delete'], "ms"=>$lang['enable'], "mu"=>$lang['disable']), $attrs2);
