...
$pagination = "maxViewConfiguration";
	...
	$elemArr = array();	for ($i = 0; $res->fetchInto($timeperiod); $i++) {
		...
		$moptions .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		$moptions .= "<select style='margin-bottom: 3px;' name='dupNbr[".$timeperiod['tp_id']."]'><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>10</option></select>";
