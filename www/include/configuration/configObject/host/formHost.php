...
$cdata->addJsData('clone-values-macro', htmlspecialchars(json_encode($macroArray), ENT_QUOTES));
...
$cdata->addJsData('clone-values-template', htmlspecialchars(json_encode($tplArray), ENT_QUOTES));
