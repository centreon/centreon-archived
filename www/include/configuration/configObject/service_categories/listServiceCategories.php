 ...
 */
	...
	for ($i = 0; $sc = $DBRESULT->fetchRow(); $i++) {
		...
		if ($sc["sc_activate"])
			$moptions .= "<a href='main.php?p=".$p."&sc_id=".$sc['sc_id']."&o=u&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icons/disabled.png' class='ico-14' border='0' alt='"._("Disabled")."'></a>&nbsp;&nbsp;";
		else
			$moptions .= "<a href='main.php?p=".$p."&sc_id=".$sc['sc_id']."&o=s&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icons/enabled.png' class='ico-14' border='0' alt='"._("Enabled")."'></a>&nbsp;&nbsp;";
		$moptions .= "&nbsp;";
