    ...
    foreach ($sc as $key => $value) {
        ...
        for ($i = 1; $i <= $nbrDup[$scId]; $i++) {
            ...
            foreach ($row as $key2 => $value2) {
                ...
                switch ($key2) {
                    case 'sc_name':
                        $value2 = filter_var($value2, FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
...
{
    global $pearDB, $centreon;
    $scName = filter_var($_POST['sc_name'], FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_NO_ENCODE_QUOTES);
