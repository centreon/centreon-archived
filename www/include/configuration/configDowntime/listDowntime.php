 ...
 */
	...
	foreach ($listDowntime as $dt) {
		...
		if ($dt["dt_activate"]) {
			$moptions .= "<a href='main.php?p=".$p."&dt_id=".$dt['dt_id']."&o=u&type=$type&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icons/disabled.png' class='ico-14' border='0' alt='"._("Disabled")."'></a>&nbsp;&nbsp;";
		} else {
			$moptions .= "<a href='main.php?p=".$p."&dt_id=".$dt['dt_id']."&o=e&type=$type&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icons/enabled.png' class='ico-14' border='0' alt='"._("Enabled")."'></a>&nbsp;&nbsp;";
		}
