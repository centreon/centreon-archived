...
*/
	...
	$Tab = array();
	$Tab[] = &HTML_QuickForm::createElement('radio', 'local', null, $lang["yes"], '1');
	$Tab[] = &HTML_QuickForm::createElement('radio', 'local', null, $lang["no"], '0');
	$form->addGroup($Tab, 'local', $lang["status"], '&nbsp;');	
	...
	$form->addRule('description', $lang['ErrRequired'], 'required');
	$form->addRule('socket_type', $lang['ErrRequired'], 'required');
	$form->addRule('socket_name', $lang['ErrRequired'], 'required');
	$form->addRule('tcp_port', $lang['ErrRequired'], 'required');
	$form->addRule('db_type', $lang['ErrRequired'], 'required');
	$form->addRule('db_host', $lang['ErrRequired'], 'required');
	$form->addRule('db_name', $lang['ErrRequired'], 'required');
	$form->addRule('db_prefix', $lang['ErrRequired'], 'required');
	$form->addRule('db_user', $lang['ErrRequired'], 'required');
	$form->addRule('db_pass', $lang['ErrRequired'], 'required');
	$form->addRule('max_timedevents_age', $lang['ErrRequired'], 'required');
	$form->addRule('max_systemcommands_age', $lang['ErrRequired'], 'required');
	$form->addRule('max_servicechecks_age', $lang['ErrRequired'], 'required');
	$form->addRule('max_eventhandlers_age', $lang['ErrRequired'], 'required');
