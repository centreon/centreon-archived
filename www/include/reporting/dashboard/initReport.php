...
$tpl->assign('style_unknown_top' , 		"style='color:#" . $colors['unknown'] . "'");
...
$tpl->assign('style_pending_top' , 		"style='color:#" . $colors['undetermined'] . "'");
...
$style["UNREACHABLE"] = "style='padding:5px;color:#" . $colors['unreachable'] . "'";
$style["UNREACHABLE_BOTTOM"] = "style='padding:5px;background-color:#" . $colors['unreachable'] . "'";
$style["UNDETERMINED"] = "style='padding:5px;color:#" . $colors['undetermined'] . "'";
