...
$tpl->assign("timerGray", returnSvg("www/img/icons/timer.svg", "var(--icons-disabled-fill-color)", 14, 14));
$tpl->assign("timerBlue", returnSvg("www/img/icons/timer.svg", "var(--icons-fill-color)", 14, 14));
