 ...
 */
	...
	function insertGraphTemplate()	{
		...
		isset($ret["grid_main_color"]) && $ret["grid_main_color"] != NULL ? $rq .= "'".htmlentities($ret["grid_main_color"], ENT_QUOTES, "UTF-8")."', ": $rq .= "NULL, ";
		isset($ret["grid_sec_color"]) && $ret["grid_sec_color"] != NULL ? $rq .= "'".htmlentities($ret["grid_sec_color"], ENT_QUOTES, "UTF-8")."', ": $rq .= "NULL, ";
		isset($ret["contour_cub_color"]) && $ret["contour_cub_color"] != NULL ? $rq .= "'".htmlentities($ret["contour_cub_color"], ENT_QUOTES, "UTF-8")."', ": $rq .= "NULL, ";
		isset($ret["col_arrow"]) && $ret["col_arrow"] != NULL ? $rq .= "'".htmlentities($ret["col_arrow"], ENT_QUOTES, "UTF-8")."', ": $rq .= "NULL, ";
