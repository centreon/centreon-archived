...
var func_displayPOPUP = function(event) {
        ...
        if (elements[0] == "host") {
                proc_popup.setXml("./include/monitoring/status/Services/xml/makeXMLForOneHost.php?"+'&host_id='+elements[1]);
                proc_popup.setXslt("./include/monitoring/status/Services/xsl/popupForHost.xsl");
        } else {
                proc_popup.setXml("./include/monitoring/status/Services/xml/makeXMLForOneService.php?"+'&svc_id='+ elements[1]);
