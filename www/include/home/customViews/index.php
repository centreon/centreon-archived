...
try {
    ...
    $template->assign('editModeIcon', returnSvg("www/img/icons/edit_mode.svg", "var(--icons-fill-color)",
                                                20, 20));
    $template->assign('noEditModeIcon', returnSvg("www/img/icons/no_edit_mode.svg", "var(--icons-fill-color)",
                                                20, 20));
