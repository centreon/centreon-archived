...
*/
	...
	$DBRESULT =& $pearDB->query("SELECT COUNT(*) FROM acl_groups" . $SearchStr);
	...
	for ($i = 0; $group = $DBRESULT->fetchRow(); $i++) {		
		...
		if ($group["acl_group_activate"])
			$moptions = "<a href='oreon.php?p=".$p."&acl_group_id=".$group['acl_group_id']."&o=u&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icones/16x16/element_previous.gif' border='0' alt='"._("Disabled")."'></a>&nbsp;&nbsp;";
		else
			$moptions = "<a href='oreon.php?p=".$p."&acl_group_id=".$group['acl_group_id']."&o=s&limit=".$limit."&num=".$num."&search=".$search."'><img src='img/icones/16x16/element_next.gif' border='0' alt='"._("Enabled")."'></a>&nbsp;&nbsp;";
		$moptions .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
