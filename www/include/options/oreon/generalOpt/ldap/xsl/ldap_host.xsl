		...
		<xsl:element name="tr">
			<xsl:element name="td">
				...
				<xsl:for-each select="//ldap_host">
					<xsl:element name='table'>
						<xsl:attribute name='id'>regularTable_<xsl:value-of select="id"/></xsl:attribute>
				        ...
				        <xsl:element name='tbody'>
				            <xsl:element name='tr'>
				            	...
				            	<xsl:element name='td'> 
				            		Ldap server #<xsl:value-of select='order'/>
				            		<xsl:element name="input">
										<xsl:attribute name="type">hidden</xsl:attribute>
										<xsl:attribute name="name">ldapHosts[<xsl:value-of select='id'/>][id]</xsl:attribute>
				            		...
				            		<xsl:element name='img'>
										...
										<xsl:attribute name='onClick'>
											if (confirm("<xsl:value-of select='//main/labels/confirmDeletion'/>")) {
												removeTr("regularTable_<xsl:value-of select='id' />");
											}
										</xsl:attribute>
									</xsl:element>
				            	</xsl:element>
				...
				<xsl:element name='div'>
                        <xsl:attribute name='id'>additionalRow_<xsl:value-of select='//main/nextRowId'/></xsl:attribute>
                </xsl:element>
			</xsl:element>
		</xsl:element>
	</xsl:element>
