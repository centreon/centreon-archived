...
*/
	...
	$tpl = new Smarty();
	$tpl = initSmartyTpl($path.'ndo/', $tpl);
	...
	if ($form->validate())	{
		# Update in DB
		updateNDOConfigData($form->getSubmitValue("gopt_id"));
	...
	$form->addElement("button", "change", $lang['modify'], array("onClick"=>"javascript:window.location.href='?p=".$p."&o=ndo'"));
