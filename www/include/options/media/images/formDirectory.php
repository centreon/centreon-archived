 ...
 * Change Directory
 */
if ($o == IMAGE_MODIFY_DIRECTORY && is_int($dir_id)) {
    $DBRESULT = $pearDB->query(
        'SELECT * FROM view_img_dir WHERE dir_id = ' . $dir_id . ' LIMIT 1'
    );
    ...
    foreach (array_keys($list) as $selector) {
...
if ($form->validate()) {
    ...
    /* modify dir */
        ...
        $dir_id = (int) $form->getSubmitValue('dir_id');
