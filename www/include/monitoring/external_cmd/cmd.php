		...
		foreach ($_GET["select"] as $key => $value){
			if (isset($_GET["cmd"]))
				switch ($_GET["cmd"]) {
					...
					case 70:	autoAcknowledgeServiceStart($key, $lang); 					break;
					case 71:	autoAcknowledgeServiceStop($key, $lang);  					break;
					case 72:	autoAcknowledgeHostStart($key, $lang); 					 	break;
					case 73:	autoAcknowledgeHostStop($key, $lang);  						break;
				
					/* Auto Notification */
					
					case 80:	autoNotificationServiceStart($key, $lang); 					break;
					case 81:	autoNotificationServiceStop($key, $lang);  					break;
					case 82:	autoNotificationHostStart($key, $lang); 					 	break;
					case 83:	autoNotificationHostStop($key, $lang);  						break;
					
					/* Auto Check */
					
					case 90:	autoCheckServiceStart($key, $lang); 					break;
					case 91:	autoCheckServiceStop($key, $lang);  					break;
					case 92:	autoCheckHostStart($key, $lang); 					 	break;
					case 93:	autoCheckHostStop($key, $lang);  						break;
				}
		}
?>