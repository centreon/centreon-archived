 ...
 */
$o = filter_input(INPUT_GET, 'o', FILTER_SANITIZE_SPECIAL_CHARS, ['options' => ['default' => 'svcSumHG_pb']]);
...
$hostgroup = filter_input(INPUT_GET, 'hg_search', FILTER_SANITIZE_SPECIAL_CHARS, ['options' => ['default' => '']]);
