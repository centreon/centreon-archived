...
$sort_type = filter_input(INPUT_GET, 'sort_type', FILTER_SANITIZE_FULL_SPECIAL_CHARS, ['options' => ['default' => 'alias']]);
$hgSearch = filter_input(INPUT_GET, 'hg_search', FILTER_SANITIZE_FULL_SPECIAL_CHARS, ['options' => ['default' => '']]);
