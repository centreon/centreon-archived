...
$hSearch = filter_input(INPUT_GET, 'host_search', FILTER_SANITIZE_FULL_SPECIAL_CHARS, ['options' => ['default' => '']]);
$sgSearch = filter_input(INPUT_GET, 'sg_search', FILTER_SANITIZE_FULL_SPECIAL_CHARS, ['options' => ['default' => '']]);
