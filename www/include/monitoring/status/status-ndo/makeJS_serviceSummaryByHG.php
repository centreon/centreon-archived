...
var _addrXSL = "./include/monitoring/status/status-ndo/templates/serviceSummaryByHG.xsl";
...
function goM(_time_reload,_sid,_o){
	...
	var _addrXML = "./include/monitoring/engine/MakeXML_Ndo_serviceSummaryByHG.php?"+'&sid='+_sid+'&search='+_search+'&search_type_host='+_search_type_host+'&search_type_service='+_search_type_service+'&num='+_num+'&limit='+_limit+'&sort_type='+_sort_type+'&order='+_order+'&date_time_format_status='+_date_time_format_status+'&o=<?php echo $obis?>&p='+_p+'&instance='+_instance;
