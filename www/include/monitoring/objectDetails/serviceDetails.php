    ...
    if ($can_display == 0) {
        ...
        if (count($outputTmp)) {
            ...
            while (isset($outputTmp[$i])) {
                if (!$i) {
                    $service_status[$hskey]["plugin_output"] = htmlentities(utf8_decode($outputTmp[$i])) . "<br />";
                } else {
                    $service_status[$hskey]["long_plugin_output"] .= htmlentities(utf8_decode($outputTmp[$i])) . "<br />";
                }
                $i++;
            }
        }
