    ...
    if (!is_null($host_id)) {
        ...
        if (!$is_admin && !isset($lcaHost["LcaHost"][$host_name])){
            ...
            $DBRESULT->free();
                ...
                echo "<div class='msg' align='center'>"._("The related service no longer exists in Centreon configuration. Please reload the configuration.")."</div>";
            }
        }
    }
    else {
...
<?php if ((!is_null($host_id)) && (!is_null($service_id))) { ?>
