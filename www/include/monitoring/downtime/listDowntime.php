...
if (isset($_POST['SearchB'])) {
    ...
    $search_service = filter_input(INPUT_POST, 'search_service', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_service"] = $search_service;
    $host_name = filter_input(INPUT_POST, 'search_host', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_host"] = $host_name;
    $search_output = filter_input(INPUT_POST, 'search_output', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_output"] = $search_output;
    $search_author = filter_input(INPUT_POST, 'search_author', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $centreon->historySearch[$url] = array();
    $search_service = filter_input(INPUT_GET, 'search_service', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]['search_service'] = $search_service;
    $host_name = filter_input(INPUT_GET, 'search_host', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_host"] = $host_name;
    $search_output = filter_input(INPUT_GET, 'search_output', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_output"] = $search_output;
    $search_author = filter_input(INPUT_GET, 'search_author', FILTER_SANITIZE_SPECIAL_CHARS);
    $centreon->historySearch[$url]["search_author"] = $search_author;
