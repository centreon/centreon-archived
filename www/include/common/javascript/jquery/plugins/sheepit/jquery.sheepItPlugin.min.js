                        ...
                        if (mv) {
                            ...
                            if(value != null){
                                value.each(function(ind,val){
                                     fieldsToFill['fields'].push(field.filter('[value="'+ val +'"]'));
                                     fieldsToFill['values'].push(val);
                                });
                            }
                            
                            
                            x = 0;
                            fieldsToFill['fields'].each(function(ind,fields){
                                fillFormField(fieldsToFill['fields'][ind] , fieldsToFill['values'][ind]);
                            });
