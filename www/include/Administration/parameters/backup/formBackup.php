...
$form->addElement('text', 'backup_backup_dir', _("Backup directory"), $attrsText);
$form->addRule('backup_backup_dir', _("Mandatory field"), 'required');
$form->addElement('text', 'backup_tmp_dir', _("Temporary directory"), $attrsText);
$form->addRule('backup_tmp_dir', _("Mandatory field"), 'required');
