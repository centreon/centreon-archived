...
reactScriptsConfig.plugins.push(new DefinePlugin({
  'process.env.COMPONENT_SOURCE_PATH': JSON.stringify(process.env.COMPONENT_SOURCE_PATH),
...
module.exports = Object.assign({}, reactScriptsConfig, {
  ...
  output: Object.assign({}, reactScriptsConfig.output, {
    path: __dirname + process.env.COMPONENT_BUILD_PATH + process.env.COMPONENT_NAME
  })
});
