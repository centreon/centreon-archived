    ...
    render() {
        ...
        return (
            <div class="wrap-right-icon round round-small white">
                <span class="icon-profile profile" onClick={this.toggle.bind(this)}>D</span>
                <div class={'submenu-top profile' + (toggled ? ' submenu-active' : null)}>
                    <div class="submenu-top-inner">
                        <ul class="submenu-top-items">
                            <li class="submenu-top-item">
                                <span class="submenu-top-item-link">
                                    <span>{fullname}</span>
                                    <span class="submenu-top-user-type">
                                        as {username}
                                    </span>
                                    <a class="submenu-top-user-edit" href="./main.php?p=50104&o=c">
                                        Edit profile
                      </a>
                                </span>
                            </li>
