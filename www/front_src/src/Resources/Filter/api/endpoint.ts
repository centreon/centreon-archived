...
const hostCategoryEndpoint = `http://localhost:4000/centreon/api/latest/monitoring/hosts/categories`;
const serviceCategoryEndpoint = `${monitoringEndpoint}/services/categories`;
