...
CREATE TABLE `cfg_nagios` (
  ...
  `retained_host_attribute_mask` BIGINT NULL,
  `retained_service_attribute_mask` BIGINT NULL,
  ...
  `max_check_result_reaper_time` INT( 11 ) NULL,
...
CREATE TABLE `contact` (
  ...
  `contact_js_effects` enum('0','1') DEFAULT '1',
