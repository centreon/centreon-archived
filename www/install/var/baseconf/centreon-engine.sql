...
UPDATE `cfg_nagios` SET `temp_file` = '@monitoring_varlog@/centengine.tmp';
...
UPDATE `cfg_nagios` SET `global_host_event_handler` = '0';
UPDATE `cfg_nagios` SET `global_service_event_handler` = '0';
...
UPDATE `cfg_nagios` SET `ocsp_timeout` = '5';
UPDATE `cfg_nagios` SET `ochp_timeout` = '5';
...
UPDATE `cfg_nagios` SET `enable_predictive_host_dependency_checks` = '';
UPDATE `cfg_nagios` SET `enable_predictive_service_dependency_checks` = '';
