   ...
   <tr>
    ...
    <td align="right">
    	<select name="mysqlVersion">
    		<option value="3" <? if (isset($_SESSION["mysqlVersion"]) && $_SESSION["mysqlVersion"] == "3") print "selected"; else if (!isset($_SESSION["mysqlVersion"])) print "selected"; ?>>>= 4.1 - PASSWORD()</option>
    		<option value="2" <? if (isset($_SESSION["mysqlVersion"]) && $_SESSION["mysqlVersion"] == "2") print "selected"; ?>>>= 4.1 - OLD_PASSWORD()</option>
    		<option value="1" <? if (isset($_SESSION["mysqlVersion"]) && $_SESSION["mysqlVersion"] == "1") print "selected"; ?>>3.x</option>
    	</select>
   	</td>
  </tr>
