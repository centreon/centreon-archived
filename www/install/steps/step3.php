 	...
 	<tr>
  	...
  	<tr>
		...
		<select name="nagios_version">
			<option value="2" <? if (isset($_SESSION["nagios_version"]) && $_SESSION["nagios_version"] == "2") print "selected"; else if (!isset($_SESSION["nagios_version"])) print "selected"; ?>>2.x</option>
    		<option value="1" <? if (isset($_SESSION["nagios_version"]) && $_SESSION["nagios_version"] == "1") print "selected"; ?>>1.x</option>
