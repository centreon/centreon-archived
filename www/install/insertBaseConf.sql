...
INSERT INTO `cfg_cgi` VALUES (10, 'CGI.cfg', '/usr/local/nagios/etc/nagios.cfg', '/usr/local/nagios/share', '/nagios', '/usr/local/nagios/libexec/check_nagios /usr/local/nagios/var/status.log 5 &#039;/usr/local/nagios/bin/nagios&#039;', '1', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'logofullsize.jpg', '4', NULL, '4', 90, NULL, NULL, NULL, NULL, NULL, '/bin/ping -n -c 5 $HOSTADDRESS$', 'Install Nagios TGZ', '1');

--
-- Contenu de la table `cfg_nagios`
--

INSERT INTO `cfg_nagios` VALUES (1, 'Nagios CFG 1', '/usr/local/nagios/var/nagios.log', '/usr/local/nagios/etc/', NULL, '/usr/local/nagios/var/nagios.tmp', '/usr/local/nagios/var/status.log', '', '0', 15, 'nagios', 'nagios', '1', '1', '1', '2', '2', '1', 'd', '/usr/local/nagios/var/archives/', '1', '1s', '/usr/local/nagios/var/rw/nagios.cmd', '/usr/local/nagios/var/downtime.log', '/usr/local/nagios/var/comment.log', '/usr/local/nagios/var/nagios.lock', '1', '/usr/local/nagios/var/status.sav', 60, '1', '2', '0', '1', '1', '1', '1', '1', '1', '2', '2', NULL, NULL, 1, 's', NULL, NULL, 's', 20, NULL, NULL, 10, 60, '2', NULL, NULL, '1', '0', '25.0', '50.0', '25.0', '50.0', '0', 60, 60, 60, 60, 1, NULL, 5, '0', NULL, '2', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '1', NULL, 60, '2', NULL, 'euro', '~!$%^&amp;*&quot;|&#039;&lt;&gt;?,()=', '`~$^&amp;&quot;|&#039;&lt;&gt;', '2', '2', 'admin', 'admin@localhost', 'TGZ Install', '1');

--
-- Contenu de la table `cfg_perfparse`
--

INSERT INTO `cfg_perfparse` VALUES (2, 'Perfparse CFG 1', 1976, '-', '/usr/local/nagios/var/serviceperf.log', 'perfparse.log', '1', 7, '/tmp/perfparse.drop', '1', 7, '/var/lock/perfparse.lock', '1', '1', '2', '2', '2', '0', '/var/log/perfparse_output_log', '1', 7, '0', 'localhost', 1974, '1', '1', '0', 'root', NULL, 'perfparse', 'localhost', 'dummy', 'mysql', 'Install TGZ', '1');
...
INSERT INTO `oreon_informations` ( `key` , `value` ) VALUES ('version', '1.3.4');
