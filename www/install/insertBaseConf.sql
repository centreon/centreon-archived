...
INSERT INTO `cfg_cgi` VALUES (10, 'CGI.cfg', '@NAGIOS_ETC@/nagios.cfg', '/usr/local/nagios/share', '/nagios', '@NAGIOS_PLUGIN@/check_nagios @INSTALL_DIR_NAGIOS@/var/status.log 5 &#039;@INSTALL_DIR_NAGIOS@/bin/nagios&#039;', '1', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'logofullsize.jpg', '4', NULL, '4', 90, NULL, NULL, NULL, NULL, NULL, '/bin/ping -n -c 5 $HOSTADDRESS$', 'Install Nagios TGZ', '1');

--
-- Contenu de la table `cfg_nagios`
--

INSERT INTO `cfg_nagios` VALUES (1, 'Nagios CFG 1', '@INSTALL_DIR_NAGIOS@/var/nagios.log', '@NAGIOS_ETC@/', NULL, '@INSTALL_DIR_NAGIOS@/var/nagios.tmp', '@INSTALL_DIR_NAGIOS@/var/status.log', '', '0', 15, '@NAGIOS_USER@', '@NAGIOS_GROUP@', '1', '1', '1', '2', '2', '1', 'd', '@INSTALL_DIR_NAGIOS@/var/archives/', '1', '1s', '@INSTALL_DIR_NAGIOS@/var/rw/nagios.cmd', '@INSTALL_DIR_NAGIOS@/var/downtime.log', '@INSTALL_DIR_NAGIOS@/var/comment.log', '@INSTALL_DIR_NAGIOS@/var/nagios.lock', '1', '@INSTALL_DIR_NAGIOS@/var/status.sav', 60, '1', '2', '0', '1', '1', '1', '1', '1', '1', '2', '2', NULL, NULL, 1, 's', NULL, NULL, 's', 20, NULL, NULL, 10, 60, '2', NULL, NULL, '1', '0', '25.0', '50.0', '25.0', '50.0', '0', 60, 60, 60, 60, 1, NULL, 5, '0', NULL, '2', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '1', NULL, 60, '2', NULL, 'euro', '~!$%^&amp;*&quot;|&#039;&lt;&gt;?,()=', '`~$^&amp;&quot;|&#039;&lt;&gt;', '2', '2', 'admin', 'admin@localhost', 'Default Nagios.cfg Generated by Oreon Auto Setup', '1', '', '');
...
INSERT INTO `oreon_informations` ( `key` , `value` ) VALUES ('version', '1.4.1');
