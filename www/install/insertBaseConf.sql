...
INSERT INTO `informations` (`key` ,`value`) VALUES ('version', '21.10.2');
...
(31, 'retry_interval', 'Retry interval', 'Time in seconds to wait between each connection attempt. The default value is 30s.', 'int', NULL),
