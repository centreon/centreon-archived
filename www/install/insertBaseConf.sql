...
INSERT INTO `cfg_cgi` VALUES (10, 'CGI.cfg', '@NAGIOS_ETC@/nagios.cfg', '/usr/local/nagios/share', '/nagios', '@NAGIOS_PLUGINS@/check_nagios @INSTALL_DIR_NAGIOS@/var/status.log 5 &#039;@INSTALL_DIR_NAGIOS@/bin/nagios&#039;', '1', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'nagiosadmin', 'logofullsize.jpg', '4', NULL, '4', 90, NULL, NULL, NULL, NULL, NULL, '/bin/ping -n -c 5 $HOSTADDRESS$', 'Install Nagios TGZ', '1');

--
-- Contenu de la table `cfg_nagios`
--

INSERT INTO `cfg_nagios` VALUES (1, 'Nagios CFG 1', '@INSTALL_DIR_NAGIOS@/var/nagios.log', '@NAGIOS_ETC@/', NULL, '@INSTALL_DIR_NAGIOS@/var/nagios.tmp', '@INSTALL_DIR_NAGIOS@/var/status.log', '', '0', 15, '@NAGIOS_USER@', '@NAGIOS_GROUP@', '1', '1', '1', '2', '2', '1', 'd', '@INSTALL_DIR_NAGIOS@/var/archives/', '1', '1s', '@INSTALL_DIR_NAGIOS@/var/rw/nagios.cmd', '@INSTALL_DIR_NAGIOS@/var/downtime.log', '@INSTALL_DIR_NAGIOS@/var/comment.log', '@INSTALL_DIR_NAGIOS@/var/nagios.lock', '1', '@INSTALL_DIR_NAGIOS@/var/status.sav', 60, '1', '2', '0', '1', '1', '1', '1', '1', '1', '2', '2', NULL, NULL, 1, 's', NULL, NULL, 's', 20, NULL, NULL, 10, 60, '2', NULL, NULL, '1', '0', '25.0', '50.0', '25.0', '50.0', '0', 60, 60, 60, 60, 1, NULL, 5, '0', NULL, '2', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '1', NULL, 60, '2', NULL, 'euro', '~!$%^&amp;*&quot;|&#039;&lt;&gt;?,()=', '`~$^&amp;&quot;|&#039;&lt;&gt;', '2', '2', 'admin', 'admin@localhost', 'Default Nagios.cfg Generated by Oreon Auto Setup', '1', NULL, NULL);

--
-- Contenu de la table `cfg_perfparse`
--

INSERT INTO `cfg_perfparse` VALUES (2, 'Perfparse', 1976, '-', '@INSTALL_DIR_NAGIOS@/var/serviceperf.log', 'perfparse.log', '1', 7, '/tmp/perfparse.drop', '1', 7, '/var/lock/perfparse.lock', '1', '1', '2', '2', '2', '0', '/var/log/perfparse_output_log', '1', 7, '0', 'localhost', 1974, '1', '1', '0', 'root', NULL, 'perfparse', 'localhost', 'dummy', 'mysql', 'Install TGZ', '1');

--
-- Contenu de la table `cfg_resource`
--

INSERT INTO `cfg_resource` VALUES (1, '$USER1$', '$USER1$=@NAGIOS_PLUGINS@', 'path to the plugins', '1');

--
-- Contenu de la table `general_opt`
--

INSERT INTO `general_opt` (`gopt_id`, `nagios_path`, `nagios_path_bin`, `nagios_path_img`, `nagios_path_plugins`, `nagios_version`, `snmp_community`, `snmp_version`, `snmp_trapd_path_conf`, `snmptt_unknowntrap_log_file`, `mailer_path_bin`, `rrdtool_path_bin`, `rrdtool_version`, `oreon_path`, `oreon_web_path`, `oreon_rrdbase_path`, `oreon_refresh`, `color_up`, `color_down`, `color_unreachable`, `color_ok`, `color_warning`, `color_critical`, `color_pending`, `color_unknown`, `session_expire`, `perfparse_installed`, `graph_preferencies`, `maxViewMonitoring`, `maxViewConfiguration`, `template`, `ldap_host`, `ldap_port`, `ldap_base_dn`, `ldap_login_attrib`, `ldap_ssl`, `ldap_auth_enable`, `patch_type_stable`, `patch_type_RC`, `patch_type_patch`, `patch_type_secu`, `patch_type_beta`, `patch_url_service`, `patch_url_download`, `patch_path_download`, `snmpttconvertmib_path_bin`, `perl_library_path`, `nagios_init_script`) VALUES (1, '@INSTALL_DIR_NAGIOS@/', '@NAGIOS_BINARY@', '@NAGIOS_IMG@', '@NAGIOS_PLUGINS@', '2', 'public', '1', '/etc/snmp/centreon_traps/', '/var/log/snmpttunknown.log', '@BIN_MAIL@', '@BIN_RRDTOOL@', '1.2', '@INSTALL_DIR_OREON@/', '/oreon/', '@INSTALL_DIR_OREON@/rrd/', 60, '#19EE11', '#F91E05', '#82CFD8', '#13EB3A', '#F8C706', '#F91D05', '#2AD1D4', '#D4D5CC', 120, '0', 1, 50, 50, 'Basic', NULL, NULL, NULL, NULL, '0', '0', 'Y', 'Y', 'Y', 'Y', 'Y', 'http://update.oreon-project.org/version.php', 'http://update.oreon-project.org/patch/', '/tmp/', '/usr/sbin/snmpttconvertmib', '/usr/local/lib', '/etc/init.d/nagios');
...
INSERT INTO `oreon_informations` ( `key` , `value` ) VALUES ('version', '1.4.2');
