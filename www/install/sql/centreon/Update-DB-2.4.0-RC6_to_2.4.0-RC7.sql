...
ALTER TABLE `connector` MODIFY `command_line` VARCHAR(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;
...
ALTER TABLE `traps` CHANGE COLUMN `traps_submit_result_enable` `traps_submit_result_enable` ENUM('0','1') NULL DEFAULT '0';
