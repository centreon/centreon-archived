...
class URIContext extends CentreonContext
{
    ...
    public function aMonitoredPassiveService()
    {
        ...
        $serviceProperties = ['description' => $this->serviceDescription, 'hosts' => $this->hostname, 'templates' => 'generic-service', 'check_command' => 'check_centreon_dummy', 'check_period' => '24x7', 'active_checks_enabled' => "0", 'passive_checks_enabled' => "1"];
    ...
    public function aCommentWhichContainsAnURI()
    {
        ...
        $this->page->setProperties(['type' => CommentMonitoringPage::TYPE_HOST, 'host' => $this->hostname, 'comment' => $this->checkOutput]);
        $this->page->save();
