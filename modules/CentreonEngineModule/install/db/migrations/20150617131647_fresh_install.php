...
class FreshInstall extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        $cfg_engine
                ...
                ->addColumn('enable_event_handlers','integer', array('null' => false, 'signed' => false, "default" => 1))
                ...
                ->addColumn('use_syslog','integer',array('signed' => false, 'null' => true, "default" => 1))
                ->addColumn('log_service_retries','integer',array('signed' => false, 'null' => true, "default" => 1))
                ->addColumn('log_event_handlers','integer',array('signed' => false, 'null' => true, "default" => 1))
                ->addColumn('log_initial_states','integer',array('signed' => false, 'null' => true, "default" => 0))
                ->addColumn('log_external_commands','integer',array('signed' => false, 'null' => true, "default" => 1))
                ->addColumn('log_passive_checks','integer',array('signed' => false, 'null' => true, "default" => 1))
                ...
                ->addColumn('enable_flap_detection','integer',array('signed' => false, 'null' => true, "default" => 0))
                ...
                ->addColumn('check_service_freshness','integer',array('signed' => false, 'null' => true, "default" => 0))
                ->addColumn('freshness_check_interval','integer',array('signed' => false, 'null' => true, "default" => 30))
                ->addColumn('check_host_freshness','integer',array('signed' => false, 'null' => true, "default" => 0))
                ->addColumn('enable_predictive_host_dependency_checks','integer',array('signed' => false, 'null' => true, "default" => 1))
                ->addColumn('enable_predictive_service_dependency_checks','integer',array('signed' => false, 'null' => true, "default" => 0))
                ...
                ->addColumn('debug_verbosity','integer',array('signed' => false, 'null' => true))
