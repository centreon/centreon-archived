...
class IndexData extends CentreonStorageBaseModel
{
    ...
    protected static $uniqueLabelField = "metric_name";
    protected static $simpleRelation = array(
        'host_id' => '\CentreonRealtime\Models\Host',
        'service_id' => '\CentreonRealtime\Models\Service'
    );
}
