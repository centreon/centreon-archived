...
class Servicetag extends CentreonRelationModel
{
    protected static $relationTable = "cfg_acl_resources_tags_services_relations";
    ...
    public static $secondObject = "\CentreonConfiguration\Models\Servicetag";
}
