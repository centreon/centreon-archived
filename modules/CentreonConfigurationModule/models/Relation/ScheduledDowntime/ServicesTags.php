...
class ServicesTags extends CentreonRelationModel
{
    protected static $relationTable = "cfg_downtimes_servicetags_relations";
    protected static $firstKey = "dt_id";
    protected static $secondKey = "service_tag_id";
