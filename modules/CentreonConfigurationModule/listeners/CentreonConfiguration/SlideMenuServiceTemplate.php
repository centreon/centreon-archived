...
class SlideMenuServiceTemplate 
{
    ...
    public static function execute(SlideMenuEvent $event)
    {
        ...
        try{
            ...
            $event->setDefaultMenu(
                array(
                    'name' => 'host',
                    'url' => $router->getPathFor('/centreon-configuration/servicetemplate/snapshotslide/') . $event->getId(),
                    'icon' => '',
                    'order' => 0,
            ...
            $event->addMenu(
                array(
                    'name' => 'command',
                    'url' => $router->getPathFor('/centreon-configuration/servicetemplate/'.$event->getId().'/command'),
                    'icon' => '',
                    'order' => 5,
